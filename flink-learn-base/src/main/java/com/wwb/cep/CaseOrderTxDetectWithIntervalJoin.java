...
import com.wwb.bean.OrderEvent;
import com.wwb.bean.TxEvent;
 ...
 * @Version 1.0
 */
public class CaseOrderTxDetectWithIntervalJoin {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<OrderEvent> orderDS = env
                .readTextFile("/Users/wangwenbo/Data/OrderLog.csv")
        ...
        SingleOutputStreamOperator<TxEvent> txDS = env
                .readTextFile("/Users/wangwenbo/Data/ReceiptLog.csv")
